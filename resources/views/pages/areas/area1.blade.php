					...
					<div id="collapse2" class="panel-collapse collapse ">
					  <div class="panel-body parameter-panel">
						    	...
						    	<li><a href="/area1/1s1_1">The institution has a system of determining its Vision and Mission.</a></li>
						      	...
						      	<li data-toggle="collapse" href="#sub-parameter2"><a href="">The objectives of the program have the expected outcomes in terms of competencies (skills and knowledge), values and other attributes of the graduates which include the development of: <span class="glyphicon glyphicon-chevron-down"></span></a></li>
							      	<ol id="sub-parameter2" class="panel-collapse collapse">
										...
										<li><a href="#">Students’ own ideas, desirable attitudes and personal discipline</a></li>
										<li><a href="#">Moral character</a></li>
										<li><a href="#">Critical, analytical, problem solving and other higher order thinking skills</a></li>
										<li><a href="#">Aesthetic and cultural values.</a></li>
								    </ol>
						    </ol>
							</td>
						</tr>
						...
						<tr>
							<td>
							<ol id="collapse2" class="accrdn">
								<li><a href="">The Institution/College conducts review on the statement of the Vision and Mission as Well as its goals and program objectives for the approval of authorities concerned.</a></li>
						      	<li><a href="">The College’s/Academic Unit follows a system of formulating its goals and the objectives of the program.</a></li>
						      	<li><a href="">The College’s/Academic Unit’s faculty, personnel, students and other stakeholders (cooperating agencies, linkages, alumni, industry sector and other concerned groups) participate in the formulation, review and/or revision of the VMGO.</a></li>
						   	</ol>
							</td>
						</tr>
						<!-- OUTCOME -->
						<thead>	
							...
							<tr>
								<td>
								<ol id="collapse2" class="accrdn">
						      		<li><a href="">The VMGO are crafted and duly approved by the BOR/BOT.program objectives for the approval of authorities concerned.</a></li>
						      	</ol>
							    </td>
							</tr>
		  				</table>
	  		...
	  		<div class="panel panel-default">
				...
				<div id="collapse3" class="panel-collapse collapse">
					...
					<tr>
						<td>
						<ol class="accrdn">
							<li><a href="">The VMGO are available on bulletin boards, in catalogs/manuals and in other forms of communication media.</a></li>
				      	</ol>
						</td>
					</tr>
					</tbody>
						...
						<ol class="accrdn">
							...
							<li data-toggle="collapse" href="#sub-parameter4"><a href=""> The formulation/review/revision of the VMGO is participated in by the following: <span class="glyphicon glyphicon-chevron-down"></span></a></li>
								<ol id="sub-parameter4" class="panel-collapse collapse">
									...
									<li><a href="#">Other stackholders</a></li>
								</ol>
							<li><a href="#">The faculty and staff perform their jobs/functions in consonance with the VMGO.</a></li>
							<li><a href="#">The VMGO are widely disseminated to the different agencies, institutions, industry sector and the community.</a></li>
				      	</ol>
						</td>
					</tr>
					</tbody>
						...
						<ol class="accrdn">
							...
							<li data-toggle="collapse" href="#sub-parameter5"><a href=""> There is congruency between actual educational practices and activities with the following: <span class="glyphicon glyphicon-chevron-down"></span></a></li>
								<ol id="sub-parameter5" class="panel-collapse collapse">
									...
									<li><a href="#">Goals of the College/Academic Unit;</a></li>
									<li><a href="#">The goals and objectives are being achieved.</a></li>
								</ol>
				      	</ol>
						</td>
					</tr>
