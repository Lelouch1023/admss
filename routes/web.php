...
Route::get('/area4/{id}', 'PagesController@viewarea');
Route::get('/area5/{id}', 'PagesController@viewarea');
Route::get('/area6/{id}', 'PagesController@viewarea');
Route::get('/area7/{id}', 'PagesController@viewarea');
